...
ELAdata_touse_forFA_noNAs <- read.csv('ELAdata_forFA_noNAs.csv')
```


```{r}
###getting the correlation matrix of the data we currently have. This will allow us to determine whether certain variables are highly correlated with one another. NB. Had to move demo_comb_income_v2 from p (polytomous) as too many categories
