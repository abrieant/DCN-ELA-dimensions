...
#need to compare this with original and make sure included subject keys match
write.csv(ELAdata_norel, file = "ELAdata_norel_new.csv", row.names = FALSE)

ELAdata_norel_old <- read.csv('/Users/ab3377/Library/CloudStorage/GoogleDrive-ab3377@yale.edu/My Drive/CANDLab/Projects/abcd-ela-dimensions/01_ela_dimensions_mixcor_ABCD4/02_factor_analysis/ELAdata_norel.csv')

identical(ELAdata_norel$subjectkey,ELAdata_norel_old$subjectkey)

common <- intersect(ELAdata_norel$subjectkey,ELAdata_norel_old$subjectkey)
#only 8978 common... 876 different

#ID sorting may have been different? resulting in different sibs being excluded now?
#how were they originally sorted? --> based on imaging IDs that Jenny identified? (see below)
...
#could try and replicate this merge/sort... or provide a .csv with the subjectkeys that were included
